...
function getPost() {
	...
	window.open('https://twitter.com/share?url=https://0505Keitan.github.io&text=今は' + year + '年' + mon + '月' + day + '日' + hour + '時' + min + '分' + sec + '秒です！- #nowTime', '_blank', 'width=450,height=500');
}
